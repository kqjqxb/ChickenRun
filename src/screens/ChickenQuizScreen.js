                                    ...
                                    {todayChickenQuestionsData[currentChickenQuizQuestionIndex].chickenAnswers.map((option, index) => {
                                        ...
                                        return (
                                            <TouchableOpacity
                                                ...
                                                {!isChickenAnswerGiven && choosenChickenAnswer?.chickenAnswer === option.chickenAnswer && (
                                                    <LinearGradient
                                                        style={{ position: 'absolute', left: 0, right: 0, top: 0, bottom: 0, borderRadius: dimensions.width * 0.04 }}
